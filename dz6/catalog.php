...
foreach($result as $item){
         ...
         {$item['product_name']}<br>Просмотров: {$item['product_view']} <a href=product.php?id={$item['id']}><img src=" . IMG_SRC . "{$item['product_image']}></a>Цена: {$item['product_price']}<a href=editProduct.php?id={$item['id']}>Редактировать товар</a>
         </div>";     
}
