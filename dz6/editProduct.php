...
while($row = mysqli_fetch_assoc($result)){
         ...
         {$row['product_name']}<br>Просмотров: {$row['product_view']} <img src=" . IMG_SRC . "{$row['product_image']}>Цена: {$row['product_price']} Р
         </div>";     
...
<form enctype="multipart/form-data" action="editProduct.php" method="POST">
    ...
    <input type="hidden" name="oldImage" value="<?= $prodImage ?>">
